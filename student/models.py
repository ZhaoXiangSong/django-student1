...
class Student(models.Model):
    ...
    avatar = models.ImageField(verbose_name='头像',upload_to='image/avatar',null=True,blank=True)
    ...
    # 初中生，班级对学生一对多关系，外键。  大学生换教室 多对多关系
...
# question.chocie_set 这种由一查多的思维跟原始sql相反，反向查询。
# django manytomany 报错 reversename clish .. 反向查询名字冲突
